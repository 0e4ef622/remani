    ...
    pub(super) fn event(
        ...
        if let Some(r) = e.render_args() {
            window.gl.draw(r.viewport(), |c, gl| {
                let [width, height] = r.window_size;
                ...
                let play_x = width / 2.0 - play_w / 2.0;
                let play_y = height / 4.0 - play_h / 2.0;
                ...
                let options_x = width / 2.0 - options_w / 2.0;
                let options_y = height / 2.0 - options_h / 2.0;
                ...
                let exit_x = width / 2.0 - exit_w / 2.0;
                let exit_y = 3.0 * height / 4.0 - exit_h / 2.0;
