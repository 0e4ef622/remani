...
impl Options {
    pub(super) fn new(window: &WindowContext, config: &Config) -> Self {
        ...
        ui.handle_event(conrod_core::event::Input::Motion(conrod_core::input::Motion::MouseCursor { x: window.mouse_position[0], y: window.mouse_position[1] }));
    ...
    fn set_ui(&mut self, config: &mut Config, window_context: &mut WindowContext) {
        let back_button;
        {
            ...
            // Scrollbar
            conrod_core::widget::Scrollbar::y_axis(self.ids.main_canvas)
                .auto_hide(true)
            ...
            { // Window resolution setting
                ...
                // Text description
                conrod_core::widget::Text::new("Window resolution")
                ...
                let color = match self_win_res_h_text.parse::<f64>() {
                    ...
                    _ => conrod_core::color::RED,
                };
                conrod_core::widget::TextBox::new(self_win_res_h_text)
                    .font_size(ui.theme().font_size_small)
                    .w_h(50.0, 20.0)
                    ...
                    .into_iter()
                    .fold(None, |a, e| if let conrod_core::widget::text_box::Event::Update(s) = e { Some(s) } else { a })
                ...
                conrod_core::widget::TextBox::new(self_win_res_w_text)
                    .font_size(ui.theme().font_size_small)
                    .w_h(50.0, 20.0)
                    .left(5.0)
                    .color(color)
            ...
            { // Audio buffer size setting
                ...
                // Text description
                conrod_core::widget::Text::new("Audio buffer size")
                    .font_size(ui.theme().font_size_small)
                ...
                conrod_core::widget::TextBox::new(self_audio_buf_size_input_text)
                    .font_size(ui.theme().font_size_small)
                    .w_h(60.0, 20.0)
            ...
            { // Audio offset setting
                ...
                // Text description
                conrod_core::widget::Text::new("Audio offset (measured in seconds)")
                    .font_size(ui.theme().font_size_small)
                ...
                conrod_core::widget::TextBox::new(self_audio_offset_input_text)
                    .font_size(ui.theme().font_size_small)
                    .w_h(50.0, 20.0)
            ...
            { // Scroll speed setting
                ...
                // Text description
                conrod_core::widget::Text::new("Scroll speed (measured in lane heights per second)")
                    .font_size(ui.theme().font_size_small)
                ...
                conrod_core::widget::TextBox::new(self_scroll_speed_input_text)
                    .font_size(ui.theme().font_size_small)
                    .w_h(50.0, 20.0)
            ...
            { // Enable osu hitsounds setting
                ...
                // Text description
                conrod_core::widget::Text::new("Enable osu hitsounds")
                    .font_size(ui.theme().font_size_small)
                ...
                let toggle = conrod_core::widget::Toggle::new(*self_enable_osu_hit_sounds_toggle_value)
                    .w_h(20.0, 20.0)
                    .top_right_of(self.ids.enable_osu_hit_sounds_canvas)
                    .border_color(conrod_core::color::WHITE);
                if *self_enable_osu_hit_sounds_toggle_value {
                    toggle.color(conrod_core::color::WHITE)
                } else {
                    toggle
            ...
            { // Keybindings
                ...
                // Text description
                conrod_core::widget::Text::new("Keybindings")
                    .font_size(ui.theme().font_size_small)
                ...
                conrod_core::widget::Canvas::new()
                    ...
                    .border(0.0)
                    .flow_right(&[
                        (self.ids.key0_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                        (self.ids.key1_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                        (self.ids.key2_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                        (self.ids.key3_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                        (self.ids.key4_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                        (self.ids.key5_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                        (self.ids.key6_canvas, conrod_core::widget::Canvas::new().h(20.0).pad_left(1.0).pad_right(1.0)),
                    ])
                    ...
                    .enumerate()
                {
                    ...
                    if Some(i) == self.keybindings_key_capture {
                        ...
                        button = button.border(1.0).border_color(conrod_core::color::WHITE);
                    } else if key_pressed {
